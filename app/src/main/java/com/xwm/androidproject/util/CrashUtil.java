...
public final class CrashUtil {
    ...
    public static void init(final String crashDirPath, final OnCrashListener onCrashListener) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && appContext.getExternalCacheDir() != null) {
            defaultDir = appContext.getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        } else {
            defaultDir = appContext.getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
