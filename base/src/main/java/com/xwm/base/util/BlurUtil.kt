...
/**
 * @author Created by Adam on 2018-10-09
 */
object BlurUtil {
    private val TAG = "BlurUtil"

    /**
     * 使用RenderScript 模糊图片，缺点：会引入多余的lib，增大安装包的体积
     *
     * @param context
     * @param source
     * @param radius
     ...
     */
    fun fastBlur(sentBitmap: Bitmap, radius: Int, scale: Float): Bitmap? {
